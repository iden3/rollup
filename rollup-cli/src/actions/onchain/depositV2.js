...
async function deposit(urlNodo, addressSC, balance, tokenId, walletEthJson, BabyjubJson, password, abi)  {
    ...
    try{
        return new Promise (async function (resolve, reject){
            let response = await contractWithSigner.deposit(balance, tokenId, address, pubKeyBabyjub, overrides)//await? promise?s
            //let response = await contractWithSigner.deposit(balance, tokenId, address, pubKeyBabyjub, overrides)
