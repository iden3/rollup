...
const deposit= require('../src/actions/onchain/depositV2.js');
const depositOnTop= require('../src/actions/onchain/depositOnTopV2.js');
const { withdraw }= require('../src/actions/onchain/withdrawV2.js');
const { forceWithdrawV2 }= require('../src/actions/onchain/forceWithdrawV2.js');
...
const { expect } = chai;
const rollupabiPath = '../src/resources/rollupabiV2.json';
