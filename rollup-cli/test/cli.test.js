...
describe('ONCHAINTX deposit', async function () {
    ...
    it('setparam wallet', (done) => {
        process.exec(`cd ..; node cli.js setparam --param wallet --value ${walletPathDefaultTest} -c ${configTest}`);
        process.exec(`cd ..; node cli.js setparam --param wallet --value ${walletPathDefaultTest}`);
        done();
    });
...
describe('ONCHAINTX depositOnTop', async function () {
    ...
    it('onchaintx depositontop', (done) => {
        const command = spawn(`cd ..; node cli.js onchaintx --type depositontop --recipient ${recipient} --loadamount 2 --tokenid 0 -c ${configTest} `, {
            shell: true,
        });
        command.stdout.on('data', (data) => {
            if ((data.toString()).includes('Password:')) {
    ...
    it('onchaintx depositontop default config.json', (done) => {
        const command = spawn(`cd ..; node cli.js onchaintx --type depositontop  -r ${recipient} --loadamount 2 --tokenid 0`, {
            shell: true,
        });
        command.stdout.on('data', (data) => {
            if ((data.toString()).includes('Password:')) {
    ...
    it('onchaintx depositontop error loadamount', (done) => {
        const command = spawn(`cd ..; node cli.js onchaintx --type depositontop -r ${recipient} --tokenid 0`, {
            shell: true,
        });
        command.stdout.on('data', (data) => {
            if ((data.toString()).includes('Password:')) {
    ...
    it('onchaintx depositontop error token id', (done) => {
        const command = spawn(`cd ..; node cli.js onchaintx --type depositontop -r ${recipient} --loadamount 2`, {
            shell: true,
        });
        command.stdout.on('data', (data) => {
            if ((data.toString()).includes('Password:')) {
...
describe('ONCHAINTX forceWithdraw', async function () {
    ...
    it('onchaintx forcewithdraw error pass', (done) => {
        const command = spawn('cd ..; node cli.js onchaintx --type forceWithdraw --amount 2 --tokenid 0', {
            shell: true,
        });
        command.stdout.on('data', (data) => {
            if ((data.toString()).includes('Password:')) {
    ...
    it('onchaintx forcewithdraw error amount', (done) => {
        const command = spawn('cd ..; node cli.js onchaintx --type forceWithdraw --tokenid 0', {
            shell: true,
        });
        command.stdout.on('data', (data) => {
            if ((data.toString()).includes('Password:')) {
...
describe('OFFCHAINTX', async function () {
    ...
    it('offchaintx send error fee', (done) => {
        const command = spawn(`cd ..; node cli.js offchaintx --type send --amount 2 --tokenid 0 -r ${recipient} -c ${configTest}`, {
            shell: true,
        });
        command.stdout.on('data', (data) => {
            if ((data.toString()).includes('Password:')) {
