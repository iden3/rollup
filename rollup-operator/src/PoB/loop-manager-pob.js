...
class LoopManager{
    ...
    async _checkWinner() {
        ...
        } else if(opWinner.forger === "0x0000000000000000000000000000000000000000" &&
            this.defaultOperator.forgerAddress === this.opManager.wallet.address){
            const beneficiaryAddress = this.opManager.wallet.address;
            this._setInfoBatch(fromBlockWinner, toBlockWinner, forgerAddress, beneficiaryAddress);
