...
//         expect(resAxAy[1].ethAddress).to.be.equal(account1.ethAddress.toString().toLowerCase());
...
//         // check leaf info matches deposit
//         expect(resEthAddress2[0].ax).to.be.equal(account2.ax);
//         expect(resEthAddress2[0].ay).to.be.equal(account2.ay);
//     });
...
//         expect(Scalar.toNumber(stateId2.amount)).to.be.equal(Scalar.toNumber(oldStateId2.amount) + tx.amount);
//         expect(Scalar.toNumber(stateId3.amount)).to.be.equal(Scalar.toNumber(oldStateId3.amount));
